...
class FirstrunSuccessPage extends ConsumerStatefulWidget {
  const FirstrunSuccessPage({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FirstrunSuccessPageState();
}
          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                Text(
                  title,
                  style: TextStyle(fontSize: 48, height: 1.1, letterSpacing: -2),
